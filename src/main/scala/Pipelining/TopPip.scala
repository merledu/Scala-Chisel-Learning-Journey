...
//     //fetch
//     val e = MuxLookup (HazardDetection_mod.io.pc_forward, 0.S, Array (
...
//     val f = MuxLookup(HazardDetection_mod.io.inst_forward, 0.S, Array(
//         (0.U) -> PC_mod.io.out,
//         (1.U) -> HazardDetection_mod.io.current_pc_out
//     ))

//     val g = MuxLookup(HazardDetection_mod.io.inst_forward, 0.U, Array(
//         (0.U) -> InstMem.io.data,
